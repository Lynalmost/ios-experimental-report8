...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let t2 = Teacher(firstName: "zhong", lastName: "Huang", age: 42, gender: Gender.female, title: "lecturer")
        let s1 = Student(firstName: "Baicheng", lastName: "Xu", age: 20, gender: Gender.male, stuNo: "2016110446")
